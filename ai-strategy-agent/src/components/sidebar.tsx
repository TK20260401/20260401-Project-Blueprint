...
const navItems = [
  ...
  { href: "/proposals/new", label: "新規作成", icon: "M12 4v16m8-8H4" },
  ...
  { href: "/analysis", label: "分析", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
];
    ...
    <aside className="flex w-56 shrink-0 flex-col border-r border-gray-100 bg-white">
      ...
      <div className="border-t border-gray-100 p-3">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700"
        >
          <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
