    ...
    <div className="min-h-screen p-4 max-w-2xl mx-auto py-8 bg-background">
      ...
      <div className="space-y-6 text-sm text-card-foreground leading-relaxed">
        <section>
          ...
          <p>ジョブサガ（以下「本アプリ」）は、お子様の金融教育を目的としたアプリケーションです。本プライバシーポリシーは、本アプリが収集する情報とその利用方法について説明します。お子様のプライバシー保護を最優先とし、個人情報保護法およびCOPPA（児童オンラインプライバシー保護法）の趣旨に配慮して運営しています。</p>
        </section>
